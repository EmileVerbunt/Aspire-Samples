...
public static class Extensions
{
        ...
        builder.Services.AddOpenTelemetry()
            ...
            .WithTracing(tracing =>
            {
                tracing.AddSource(builder.Environment.ApplicationName)
                    .AddSource("Azure.AI.Projects.*")  // Azure AI Projects SDK — emits GenAI spans visible in Aspire + Foundry
    ...
    private static TBuilder AddOpenTelemetryExporters<TBuilder>(this TBuilder builder) where TBuilder : IHostApplicationBuilder
    {
        ...
        var azureMonitorConnectionString = builder.Configuration["APPLICATIONINSIGHTS_CONNECTION_STRING"]
            ...
            ?? builder.Configuration["OIL_GAS_PROJECT_APPLICATIONINSIGHTSCONNECTIONSTRING"];
